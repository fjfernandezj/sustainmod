...
parameter
   p_cropData_censo     'crop management data commune level'
...
$load  t_cropData_2010
$gdxin

$gdxin ..\data\activities\production.gdx
$load  t_cropData_2011
$gdxin

$gdxin ..\data\activities\production.gdx
$load  t_cropData_2013
$gdxin

$gdxin ..\data\activities\production.gdx
$load  t_cropData_2014
$gdxin

$gdxin ..\data\activities\production.gdx
$load  t_cropData_2015
$gdxin

$gdxin ..\data\activities\production.gdx
$load  t_cropData_2016
$gdxin

$gdxin ..\data\activities\production.gdx
$load  t_cropData_2017
$gdxin

$gdxin ..\data\activities\production.gdx
$load  t_cropData_2018
$gdxin

$gdxin ..\data\activities\production.gdx
$load  t_cropData_2019
$gdxin

$gdxin ..\data\activities\production.gdx
$load  t_cropData_2020
$gdxin

$gdxin ..\data\markets\prdPricesReal_megasequia.gdx
$load  t_outputPriceReal
$gdxin

$gdxin ..\data\markets\prdPricesReal_megasequia.gdx
$load  t_outputPriceReal_2010
$gdxin

$gdxin ..\data\markets\prdPricesReal_megasequia.gdx
$load  t_outputPriceReal_2011
$gdxin

$gdxin ..\data\markets\prdPricesReal_megasequia.gdx
$load  t_outputPriceReal_2012
$gdxin

$gdxin ..\data\markets\prdPricesReal_megasequia.gdx
$load  t_outputPriceReal_2013
$gdxin

$gdxin ..\data\markets\prdPricesReal_megasequia.gdx
$load  t_outputPriceReal_2014
$gdxin

$gdxin ..\data\markets\prdPricesReal_megasequia.gdx
$load  t_outputPriceReal_2015
$gdxin

$gdxin ..\data\markets\prdPricesReal_megasequia.gdx
$load  t_outputPriceReal_2016
$gdxin

$gdxin ..\data\markets\prdPricesReal_megasequia.gdx
$load  t_outputPriceReal_2017
$gdxin

$gdxin ..\data\markets\prdPricesReal_megasequia.gdx
$load  t_outputPriceReal_2018
$gdxin

$gdxin ..\data\markets\prdPricesReal_megasequia.gdx
$load  t_outputPriceReal_2019
$gdxin

$gdxin ..\data\markets\prdPricesReal_megasequia.gdx
$load  t_outputPriceReal_2020
$gdxin
...
*-------Commune level  ------
p_cropData_2010(comm, act, sys, 'area') = t_cropData_2010(comm, act, sys, 'area');

p_cropData_2010(comm, act, sys, 'yld') = t_cropData_2010(comm, act, sys, 'yld');
